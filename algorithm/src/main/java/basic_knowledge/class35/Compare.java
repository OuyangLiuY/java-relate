...
import basic_knowledge.class35.Code01_AVLTreeMap.AVLTreeMap;
import basic_knowledge.class35.Code01_SizeBalanceTreeMap.SizeBalancedTreeMap;
import basic_knowledge.class35.Code02_SkipListMap.SkipListMap;
...
public class Compare {
    ...
    public static void performanceTest() {
        ...
        cSkip = new ConcurrentSkipListMap<>();
        ...
        start = System.currentTimeMillis();
        for (int i = max; i >= 0; i--) {
            cSkip.remove((int) (Math.random() * i));
        }
        end = System.currentTimeMillis();
        System.out.println("c skip 运行时间 : " + (end - start) + "ms");
